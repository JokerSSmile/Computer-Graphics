...
public class Renderer {
    ...
    public void init(Window window) throws Exception {
        ...
        shaderProgram.createVertexShader(Utils.loadResource("src/resources/shaders/vertex.vert"));
        shaderProgram.createFragmentShader(Utils.loadResource("src/resources/shaders/fragment.frag"));
        shaderProgram.link();
